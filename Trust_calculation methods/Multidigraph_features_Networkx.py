...
def general_attribute(net):
    ...
    # in_degree
    in_degree = dict(net.in_degree())
    nx.set_node_attributes(net, in_degree, "in_degree")

    # out_degree
    out_degree = dict(net.out_degree())
    nx.set_node_attributes(net, out_degree, "out_degree")
    # degree centrality
    ...
    # hubs and authority
    h, a = nx.hits(net)
    nx.set_node_attributes(net, h, "hub")
    nx.set_node_attributes(net, a, "authorithy")
...
def local_attribute(AnomaSbg, net):
    ...
    nx.set_node_attributes(net, sq_cluster_loc, "Loc_sq_clusterCo")
...
# dataset/BitcoinAlpha/RegressionBitcoinAlpha.graphml
net = nx.read_graphml(
...
with open(
    "dataset/BitcoinOTC/regression_biased/OTC_regression_biased.csv", "w", newline=""
) as csvfile:
